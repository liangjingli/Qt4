...
public:
    ...
    void setupUi(QDialog *SortDialog)
    {
        ...
        SortDialog->resize(591, 661);
        widget = new QWidget(SortDialog);
        widget->setObjectName(QString::fromUtf8("widget"));
        widget->setGeometry(QRect(390, 40, 152, 216));
        ...
        widget1->setGeometry(QRect(20, 90, 313, 507));
    ...
    void retranslateUi(QDialog *SortDialog)
    {
        ...
        primaryOrderCombo->insertItems(0, QStringList()
         ...
         << QApplication::translate("SortDialog", "Desending", 0, QApplication::UnicodeUTF8)
        );
        ...
        tertiaryGroupBox->setTitle(QApplication::translate("SortDialog", "&Tritiary Key", 0, QApplication::UnicodeUTF8));
